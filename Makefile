...
#   2025-10-16  AdministratorBegin
############################################################################

############################################################################
# Installed targets

BINS    = ipmi-gather ipmi-send

############################################################################
# List object files that comprise BIN.

GATHER_OBJS = ipmi-gather.o network.o misc.o
SEND_OBJS   = ipmi-send.o network.o misc.o
...
ipmi-gather: ${GATHER_OBJS}
	${LD} -o ipmi-gather ${GATHER_OBJS} ${LDFLAGS}

ipmi-send: ${SEND_OBJS}
	${LD} -o ipmi-send ${SEND_OBJS} ${LDFLAGS}
